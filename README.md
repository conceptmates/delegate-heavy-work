...
- **Task names** — every spawned agent is named after its job and the model it runs on
  (`review-auth-diff [sonnet]`), with the slice in the name when two agents share a job.
